...
#numOfLines=4
 #title = "India a powerful country with nice people"
text = text.replace('\t', ' ')
...
def extract_thematic_words(text):
    # Tokenize the text
    ...
    # Extracting thematic words based on POS tags
    thematic_words = [word for word, tag in tagged_tokens if tag.startswith("N")]
...
def calculate_sentence_ratio(text):
    ...
    for sentence in sentences:
        ...
        sentence_ratio = sentence_length / (max_length+1)
...
def calculate_thematic_word_feature_score(sentence, thematic_words):
    ...
    score = thematic_word_count / (len(thematic_words) +1)
    return score


sentences, words = preprocess_text(text)

thematic_words = extract_thematic_words(text)
...
for index, title1 in enumerate(title_feature_scores):
    # index1 = title_feature_scores.index(title)
    #print(index)

    title_feature_score_dict[f'sentence {index+1}']=calculate_title_feature_score_membership(title1)
...
for index, title1 in enumerate(sentence_lengths):
    # index1 = title_feature_scores.index(title)
    #print(index)

    sentence_lengths_dict[f'sentence {index+1}']=calculate_sentence_lengths_membership(title1)
...
# term_weights_dict = {}
# for index, title1 in enumerate(term_weights):
#     # index1 = title_feature_scores.index(title)
#     #print(index)

#     term_weights_dict[f'sentence {index+1}']=calculate_term_weights_membership(title1)
...
for index, title1 in enumerate(sentence_positions):
    # index1 = title_feature_scores.index(title)
    #print(index)

    sentence_positions_dict[f'sentence {index+1}']=calculate_sentence_positions_membership(title1)
...
for index, title1 in enumerate( sentence_similarities):
    # index1 = title_feature_scores.index(title)
    #print(index)

    sentence_similarities_dict[f'sentence {index+1}']=calculate_sentence_similarities_membership(title1)
...
for index, title1 in enumerate(numerical_score_ratios):
    # index1 = title_feature_scores.index(title1)
    #print(index)

    numerical_score_ratios_dict[f'sentence {index+1}'] = calculate_numerical_score_ratios_membership(title1)
...
for index, title1 in enumerate(thematic_word_feature_scores):
    # index1 = title_feature_scores.index(title)
    # print(index)

    thematic_word_feature_scores_dict[f'sentence {index+1}'] = calculate_thematic_word_feature_scores_membership(title1)
...
for index, title1 in enumerate(sentence_weights2):
    # index1 = title_feature_scores.index(title)
    # print(index)

    sentence_weights2_dict[f'sentence {index+1}'] = calculate_sentence_weights2_membership(title1)
...
summary = fuzzy_text_summarization(sentences, numOfLines)
print(summary)
#print(title)
#print(numOfLines)
#print(text)